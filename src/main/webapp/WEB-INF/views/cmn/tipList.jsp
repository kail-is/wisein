        ...
        <div class="board-list">
            ...
            <c:forEach var="tip" items="${tipBoard}">
                <div class="board-line">
                    ...
                    <div class="board-cell board-writer gray">
                        <p class="writer"><c:out value="${tip.writer}" /><br><span class="xs-off">(OK저축은행)</span><span class="xs-on">21-10-24</span></p>
                        <ul class="person-function">
