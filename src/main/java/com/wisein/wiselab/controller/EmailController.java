...
public class EmailController {
    ...
    public void authMailSend(HttpSession session,
        ...
        emailcontent.append(" <div" +
                ...
                "		감사합니다." +
                "	</p>" +
                "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://localhost:9092/authSuccess\">" +
                "		<p" +
    ...
    public void findPwMailSend(HttpSession session,
        ...
        emailcontent.append(" <div" +
                ...
                "	 style=\"text-align: center; margin: 2em; font-weight: bold;\">" +
                    changePw +
                "	</p>" +
                "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://localhost:9092/chgPw?memberToken=" +
                memberToken +
                "\">" +
                "		<p" +
                "			style=\"display: inline-block; width: 210px; height: 45px; margin: 30px 5px 40px; background: #02b875; line-height: 45px; vertical-align: middle; font-size: 16px;\">" +
    ...
    public void reportClosed(@RequestParam("matzip_id") String matzipId, MailDTO mailDTO) throws Exception {
        ...
        emailcontent.append(" <div" +
                ...
                "	 style=\"text-align: center; margin: 2em;\">" +
                "			해당 맛집 확인</p>" +
                "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://localhost:9092/matzip?id=" +
                matzipId +
                "\">" +
                "		<p" +
                ...
                "	</p>" +
                "	</a>" +
                "	<a style=\"color: #FFF; text-decoration: none; text-align: center;\" href=\"http://localhost:9092/addClosed?matzipId=" +
                matzipId +
                "\">" +
                "		<p" +
                "			style=\"display: inline-block; width: 210px; height: 45px; margin: 20px 5px; background: #02b875; line-height: 45px; vertical-align: middle; font-size: 16px;\">" +
